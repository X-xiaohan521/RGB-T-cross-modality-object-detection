...
from .ultralytics_conv import Conv, DWConv, GhostConv, LightConv, RepConv, autopad
...
class C2fPSA(C2f):
    ...
    Examples:
        >>> import torch
        >>> from src.main.ultralytics.nn.modules.block import C2fPSA
...
class SCDown(nn.Module):
    ...
    Examples:
        >>> import torch
        >>> from src.main.ultralytics.nn.modules.block import SCDown
