...
from src.main.ultralytics.cfg import TASK2DATA, get_cfg, get_save_dir
from src.main.ultralytics.engine.results import Results
from src.main.ultralytics.nn.tasks import guess_model_task, load_checkpoint, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        if self.is_hub_model(model):
            from src.main.ultralytics.hub import HUBTrainingSession
