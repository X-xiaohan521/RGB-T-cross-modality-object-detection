...
from src.main.ultralytics.data.build import load_inference_source
from src.main.ultralytics.engine.model import Model
from src.main.ultralytics.models import yolo
from src.main.ultralytics.nn.tasks import (
    ClassificationModel,
    DetectionModel,
    OBBModel,
    PoseModel,
...
from src.main.ultralytics.utils import ROOT, YAML
    ...
    def __init__(self, model: str | Path = "yolo26n.pt", task: str | None = None, verbose: bool = False):
        ...
        if "-world" in path.stem and path.suffix in {".pt", ".yaml", ".yml"}:  # if YOLOWorld PyTorch model
            ...
            if hasattr(self.model, "model") and "RTDETR" in self.model.model[-1]._get_name():  # if RTDETR head
                from src.main.ultralytics import RTDETR
